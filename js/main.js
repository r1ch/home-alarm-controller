	...
	template: `
		<div v-if = "ready" class = "row center-align">
			<div class = "col s12 center-align">
				...
				<button v-on:click = "boost()"type="button" :class = "{'orange darken-1' : boosted}" class="btn"><i class = "fas fa-temperature-high"></i></button>
			</div>
			<div class = "col s12 center-align">
				<br><br>
	...
	computed: {
		...
		strategies(){
			...
			if(strategies.length == 1){
				strategies.push({
					timestamp: new Date(this.date - 24*60*60*1000),
					detail: this.shadow.strategy
				})
			}
